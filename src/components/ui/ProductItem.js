	...
	return (
		<div className="p-3 bg-white">
			<picture className="relative block">
				<button className="w-8 h-8 flex rounded-lg absolute top-0 right-2 border shadow-md  border-gray-200 text-purple-700 transition-colors bg-white hover:bg-purple-50 items-center justify-center">
					<AiOutlinePlus />
				</button>
